...
})({"1bvWO":[function(require,module,exports) {
...
init();
async function init() {
    const { tiles, renderScale } = (0, _getScaledSettingsJs.getScaledSettings)();
    ...
    // camera
    camera = new (0, _three.PerspectiveCamera)(75, 1, 0.025, 500);
    ...
    if (window.location.hash.includes("cube")) {
        ...
        envPromise = new (0, _three.CubeTextureLoader)().loadAsync(envUrls);
        scene.environmentIntensity = 5;
        scene.backgroundIntensity = 5;
    } else envPromise = new (0, _rgbeloaderJs.RGBELoader)().loadAsync(ENV_URL).then((tex)=>{
        tex.mapping = (0, _three.EquirectangularReflectionMapping);
        return tex;
    });
...
},{"three":"ktPTu","../core/MeshBVH.js":"biELs","./utils/WorkerBase.js":"bGfl5","../utils/BufferUtils.js":"gBAF9","./GenerateMeshBVHWorker.js":"3qwBo","../core/build/geometryUtils.js":"ejhro","fcf328a20d6da8f8":"jTzQ3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bGfl5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"three":"ktPTu","../core/MeshBVH.js":"biELs","./utils/WorkerBase.js":"bGfl5","a30a60cb1342ab0e":"csGg8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"csGg8":[function(require,module,exports) {
let workerURL = require("cadcfda86d190c5a");
let bundleURL = require("3cf31fa25ad9bb66");
let url = bundleURL.getBundleURL("f3s6y") + "generateMeshBVH.worker.e1a14054.js";
module.exports = workerURL(url, bundleURL.getOrigin(url), false);

},{"cadcfda86d190c5a":"cn2gM","3cf31fa25ad9bb66":"lgJ39"}],"cn2gM":[function(require,module,exports) {
"use strict";
...
},{}],"jTzQ3":[function(require,module,exports) {
let workerURL = require("7db0409b7cb01e1");
let bundleURL = require("1ef32a9c697e4c86");
let url = bundleURL.getBundleURL("f3s6y") + "parallelMeshBVH.worker.fa7afa10.js";
module.exports = workerURL(url, bundleURL.getOrigin(url), false);

},{"7db0409b7cb01e1":"cn2gM","1ef32a9c697e4c86":"lgJ39"}],"lfwhv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1bvWO"], "1bvWO", "parcelRequire5b70")

//# sourceMappingURL=basic.e4492928.js.map

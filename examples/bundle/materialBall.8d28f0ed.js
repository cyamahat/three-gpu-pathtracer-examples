...
})({"cJAJ1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MaterialOrbSceneLoader", ()=>MaterialOrbSceneLoader);
...
class MaterialOrbSceneLoader {
    constructor(manager){
        this.manager = manager;
    }
    loadAsync(url = ORB_SCENE_URL, ...rest) {
        return new (0, _gltfloaderJs.GLTFLoader)(this.manager).loadAsync(url, ...rest).then((gltf)=>{
            const { scene, cameras } = gltf;
            const leftLight = new (0, _three.RectAreaLight)(0xffffff, 1, 15, 15);
            assignWatts(leftLight, 6327.84);
            scene.getObjectByName("light").add(leftLight);
            for(let i = 0; i < 4; i++){
                const light = new (0, _three.RectAreaLight)(0xffffff, 1, 24.36, 24.36);
            ...
            scene.traverse((c)=>{
                if (c.material) c.material.vertexColors = false;
            });
...
},{"three":"ktPTu","three/examples/jsm/loaders/GLTFLoader.js":"dVRsF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kWNzB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RectAreaLightUniformsLib {
    static init() {
        ...
        (0, _three.UniformsLib).LTC_FLOAT_1 = new (0, _three.DataTexture)(ltc_float_1, 64, 64, (0, _three.RGBAFormat), (0, _three.FloatType), (0, _three.UVMapping), (0, _three.ClampToEdgeWrapping), (0, _three.ClampToEdgeWrapping), (0, _three.LinearFilter), (0, _three.NearestFilter), 1);
        (0, _three.UniformsLib).LTC_FLOAT_2 = new (0, _three.DataTexture)(ltc_float_2, 64, 64, (0, _three.RGBAFormat), (0, _three.FloatType), (0, _three.UVMapping), (0, _three.ClampToEdgeWrapping), (0, _three.ClampToEdgeWrapping), (0, _three.LinearFilter), (0, _three.NearestFilter), 1);
        (0, _three.UniformsLib).LTC_FLOAT_1.needsUpdate = true;
        (0, _three.UniformsLib).LTC_FLOAT_2.needsUpdate = true;
        const ltc_half_1 = new Uint16Array(LTC_MAT_1.length);
        LTC_MAT_1.forEach(function(x, index) {
            ltc_half_1[index] = (0, _three.DataUtils).toHalfFloat(x);
        });
        const ltc_half_2 = new Uint16Array(LTC_MAT_2.length);
        LTC_MAT_2.forEach(function(x, index) {
            ltc_half_2[index] = (0, _three.DataUtils).toHalfFloat(x);
        });
        (0, _three.UniformsLib).LTC_HALF_1 = new (0, _three.DataTexture)(ltc_half_1, 64, 64, (0, _three.RGBAFormat), (0, _three.HalfFloatType), (0, _three.UVMapping), (0, _three.ClampToEdgeWrapping), (0, _three.ClampToEdgeWrapping), (0, _three.LinearFilter), (0, _three.NearestFilter), 1);
        (0, _three.UniformsLib).LTC_HALF_2 = new (0, _three.DataTexture)(ltc_half_2, 64, 64, (0, _three.RGBAFormat), (0, _three.HalfFloatType), (0, _three.UVMapping), (0, _three.ClampToEdgeWrapping), (0, _three.ClampToEdgeWrapping), (0, _three.LinearFilter), (0, _three.NearestFilter), 1);
        (0, _three.UniformsLib).LTC_HALF_1.needsUpdate = true;
        (0, _three.UniformsLib).LTC_HALF_2.needsUpdate = true;
    }
}

},{"three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},[], null, "parcelRequire5b70")

//# sourceMappingURL=materialBall.8d28f0ed.js.map
